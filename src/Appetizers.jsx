...
function Appetizers({ openDetail, searchQuery }) {
  const [items] = useState([
    { id: 1, name: 'Fried Mozzarella', description: 'Golden-fried mozzarella cheese.', price: 9.99 },
    { id: 2, name: 'Stuffed Mushrooms', description: 'Baked with clams, parmesan, romano, and mozzarella cheese.', price: 10.99 },
  ...
  return (
    <div>
      <h2 className="text-3xl mb-4">Appetizers</h2>
