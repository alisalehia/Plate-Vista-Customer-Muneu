...
function ClassicEntrees({ openDetail, searchQuery }) {
  const [items] = useState([
    { id: 1, name: 'Spaghetti & Meatballs', description: 'Spaghetti with meatballs and marinara sauce.', price: 17.99 },
    { id: 2, name: 'Chicken Marsala', description: 'Sautéed chicken breast with mushrooms and marsala wine sauce.', price: 23.99 },
