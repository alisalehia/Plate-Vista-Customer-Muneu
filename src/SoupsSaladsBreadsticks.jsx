...
function SoupsSaladsBreadsticks({ openDetail, searchQuery }) {
  const [items] = useState([
    { id: 1, name: 'Zuppa Toscana', description: 'Spicy sausage, kale, and potatoes in a creamy broth.', price: 7.99 },
    { id: 2, name: 'House Salad', description: 'Crisp greens, tomatoes, and olives.', price: 6.99 },
